...
<v-container align="center">
    <v-row>
        <v-col>
            <v-card class="pa-6" width="600" color="pink-lighten-1">
...
<v-text-field  v-model="phoneNumber" label="Phone" type="number"></v-text-field>
<v-text-field v-model="deliveryAddress" label="Delivery Address" :rules="[(v) => !!v || 'Delivery Address is required']" >
</v-text-field>
